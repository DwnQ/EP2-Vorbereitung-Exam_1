    ...
    public static void main(String[] args) {
        checkAndPrint(
                ...
                new Question(
                        ...
                        new Choice(true, "Assoziative Datenstrukturen sind (effizient) wahlfrei zugreifbar.             (2A)"),
                        new Choice(true, "Lineare Datenstrukturen können bei Bedarf größer werden.                      (2B)"),
                ...
                new Question(
                        ...
                        new Choice(true, "'(Y)null' liefert einen Laufzeitfehler.                                       (3C)"),
                ...
                new Question(
                        ...
                        new Choice(true, "n.put(K, C); n.put(n.get(K), n.get(C)); n.put(C, K);                          (4B)"),
                        ...
                        new Choice(true, "n.put(C, K); n.put(K, C); n.put(n.get(C), n.get(K));                          (4E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(true, "e.addFirst(9); e.addFirst(6); e.pollFirst();                                  (5A)"),
                        new Choice(true, "e.addFirst(9); e.addFirst(6); e.addFirst(e.peekLast());                       (5B)"),
                        new Choice(false, "e.addFirst(9); e.addFirst(6); e.peekFirst();                                  (5C)"),
                        new Choice(true, "e.addLast(9); e.addLast(6); e.pollLast();                                     (5D)"),
