    ...
    public static void main(String[] args) {
        checkAndPrint(
                ...
                new Question(
                        ...
                        new Choice(true, "LinkedList<E> ist Untertyp von Collection<E>                                       (1B)"),
                        new Choice(true, "Aus einer Queue<E> kann man Elemente mittels remove und poll löschen.              (1C)"),
                        new Choice(true, "LinkedHashSet<E> implementiert Set<E>.                                             (1D)"),
                        new Choice(true, "TreeSet<E> verbietet mehrere gleiche Einträge.                                     (1E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(true, "Nicht validierbare Daten müssen zurückgewiesen werden.                             (2B)"),
                        new Choice(true, "Unzureichende Prüfung kann z.B. zu einer SQL-Injection führen.                     (2C)"),
                        new Choice(true, "Reguläre Ausdrücke können Prüfungen von Datenformaten vereinfachen.                (2D)"),
                ...
                new Question(
                        ...
                        new Choice(true, "Vorbedingung: n > 0.                                                               (3A)"),
                        new Choice(true, "Nachbedingung: Halbiert (n * (n + 1)).                                             (3B)"),
                ...
                new Question(
                        ...
                        new Choice(true, "Invarianten beziehen sich auf einzelne Methoden.                                   (4A)"),
                        new Choice(true, "Vorbedingungen beschreiben häufig Eigenschaften von Parametern.                    (4B)"),
                        ...
                        new Choice(true, "Nachbedingungen beziehen sich auf einzelne Methoden.                               (4E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(true, "Formale Korrektheitsbeweise sind für große Programme extrem aufwendig.             (5A)"),
                        new Choice(true, "Design-by-Contract kann Missverständnisse früh erkennen lassen.                    (5B)"),
                        new Choice(true, "Konfigurierbarkeit kann die Brauchbarkeit des Programms verbessern.                (5C)"),
                        new Choice(true, "Qualitätsanforderungen sollen analysiert und dargestellt werden.                   (5D)"),
